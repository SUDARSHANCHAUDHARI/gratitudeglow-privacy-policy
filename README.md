...
GratitudeGlow ("we," "our," or "us") is an Android app. GratitudeGlow is a guided gratitude journaling app for Android that can sync account and journal data through Firebase. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using GratitudeGlow you agree to the practices described below.

## Information We Collect

### Location Data
- GratitudeGlow does not collect location data.

### Account Information
- If you sign in, we collect account information such as Firebase user ID, email address, display name, and authentication provider.
- Journal entries, gratitude prompts, streaks, and app preferences may be associated with your account.

### Device Information
- App preferences and sync state may be stored locally. Firebase may process device and usage data needed for authentication and cloud sync.

## How We Use Your Information

### Location Sharing
- GratitudeGlow does not use your location.

### Account Management
- Create and manage your account.
- Sync gratitude journal content across devices.
- Maintain streaks, reminders, and app preferences.

### Service Improvement
- Improve reliability and sync behavior.
...
### Data Storage
- Journal content and account data may be stored in Firebase services such as Firebase Authentication and Firestore.
- Local preferences and cached journal data may be stored on your device.

### Data Retention
- Account and journal data are retained while your account is active.
- You can request deletion at any time; deletion requests are processed within 30 days unless a shorter period is required by law.
...
### Family Groups
- GratitudeGlow does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
- No journal content is sold or shared with advertising networks.
...
* Notifications may be available for reminders if implemented in the app version you use.

## Your Rights and Controls

### Location Sharing Control
- No location sharing exists in GratitudeGlow.

### Account Management
- You can sign out or request account deletion.
- You can edit or delete journal content in the app.

### Data Access
- You can view your journal content in the app and request export or deletion by email.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> GratitudeGlow -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/gratitudeglow-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/GratitudeGlow
...
- Subject: "Data Deletion Request - GratitudeGlow"
...
1. Open GratitudeGlow, if installed
...
- Firebase Firestore or related Firebase database services
- Google authentication services where used
...
GratitudeGlow is built with privacy in mind. The app is built with:
- Kotlin and Jetpack Compose
- Firebase for authentication and cloud sync
- Local storage for preferences and offline/cache behavior
